      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          ...
          <div className="bg-white rounded-lg shadow-lg overflow-hidden group">
            <img
              src="D:\web\portofolio - Copy\public\furnature-and-kitchen.png" // Assuming this is in your public folder
          ...
          <div className="bg-white rounded-lg shadow-lg overflow-hidden group">
            <img
              src="D:\web\portofolio - Copy\public\534816.jpg" // Assuming this is in your public folder
          ...
          <div className="bg-white rounded-lg shadow-lg overflow-hidden group">
            <img
              src="D:\web\portofolio - Copy\public\Food-and-Beverage.webp" // Assuming this is in your public folder
          ...
          <div className="bg-white rounded-lg shadow-lg overflow-hidden group">
            <img
              src="D:\web\portofolio - Copy\public\health-and-beauty.jpg" // Assuming this is in your public folder
          ...
          <div className="bg-white rounded-lg shadow-lg overflow-hidden group">
            <img
              src="D:\web\portofolio - Copy\public\fashion.jpeg" // Assuming this is in your public folder
          ...
          <div className="bg-white rounded-lg shadow-lg overflow-hidden group">
            <img
              src="D:\web\portofolio - Copy\public\car.png" // Assuming this is in your public folder
              alt="Automotive"
              // MODIFIED LINE: Changed object-cover to object-contain for this image
              className="w-full h-48 object-cover transform transition-transform duration-500 group-hover:scale-110"
              onError={(e: React.SyntheticEvent<HTMLImageElement, Event>) => { e.currentTarget.onerror = null; e.currentTarget.src="https://placehold.co/400x250/C7D2FE/374151?text=Placeholder+Image"; }}
          ...
          <div className="bg-white rounded-lg shadow-lg overflow-hidden group">
            <img
              src="D:\web\portofolio - Copy\public\builfing.png"
          ...
          <div className="bg-white rounded-lg shadow-lg overflow-hidden group">
            <img
              src="D:\web\portofolio - Copy\public\machines.png"
          ...
          <div className="bg-white rounded-lg shadow-lg overflow-hidden group">
            <img
              src="D:\web\portofolio - Copy\public\papers.png"
              alt="Miscellaneous"
              className="w-full h-48 object-cover transform transition-transform duration-500 group-hover:scale-110"
              onError={(e: React.SyntheticEvent<HTMLImageElement, Event>) => { e.currentTarget.onerror = null; e.currentTarget.src="https://placehold.co/400x250/C7D2FE/374151?text=Placeholder+Image"; }}
            />
